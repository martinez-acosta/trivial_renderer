...
float TVector3D::length() const { return std::sqrt(x * x + y * y + z * z); }

float TVector3D::lengthSquared() const { return x * x + y * y + z * z; }

bool TVector3D::isCeroVector() const {
...
float TVector3D::dotProduct(const TVector3D &v1, const TVector3D &v2) const {
...
/*
TVector3D TVector3D::crossProduct(const TVector4D &v1,
